...
Each extension has its own folder within the "TableauExtensions" directory. All files associated with extension will be found there, including: twb/twbx, trex, html, and javascript.
